    ...
    <>
      <div className="bg-white p-3 lg:pr-10 pr-7 pl-[22px]">
        <button
          ...
          className={`cursor-pointer flex justify-center items-center rounded-full min-md:hidden w-11 h-11 bg-light-green ${
        ...
        >
          ...
          <ul
            className={`bg-light min-md:flex min-md:items-center min-md:pb-0 pb-1 min-md:w-auto min-md:pl-0 self-start pt-6 min-md:pt-0`}
          >
