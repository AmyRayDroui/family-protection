...
export default function AboutTheCompany({ data }: HomePageType) {
  return (
    <WrapperLarge
      id="about-us"
    ...
    >
      <img
        ...
        className="justify-self-end sm:justify-self-center max-h-[586px] border border-grey rounded-xl"
      ></img>
      <div className="flex flex-col pt-10 px-24 md:px-8 min-sm:px-8 xs:p-0">
        <h3 className="text-accent-green text-md sm:text-sm sm:mt-10">
          {data.homepage.aboutheading}
        </h3>
        <h2 className="text-xl font-bold sm:text-xl-mobile">
          {data.homepage.abouttitle}
        </h2>
        <p className="text-paragraph mt-14 sm:mt-9">
